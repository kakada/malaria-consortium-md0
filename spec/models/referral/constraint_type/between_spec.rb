...
describe Referral::ConstraintType::Between do
  
  it "should validate number 30 between 20, 31 with no error" do
    betweenValidator = Referral::ConstraintType::Between.new(20, 31)
  ...
  it "should validate number 30 between 20 , 28 with error" do
    betweenValidator = Referral::ConstraintType::Between.new(20, 28)
