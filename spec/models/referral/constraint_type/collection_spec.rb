...
describe Referral::ConstraintType::Collection do
  
  it "should validate string 'aaa' in collection (aaa,bbb, ddd) without error" do
    collectionValidator = Referral::ConstraintType::Collection.new "aaa,bbb, ddd" 
  ...
  it "should validate string 'aaa' in collection (ccc, bbb, ddd) with error" do
    collectionValidator = Referral::ConstraintType::Collection.new "ccc, bbb, ddd"
