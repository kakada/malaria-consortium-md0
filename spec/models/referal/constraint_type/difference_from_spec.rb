...
describe Referal::ConstraintType::DifferenceFrom do
  it "should validate number 40 again max 30 with no error" do
    diffValidator = Referal::ConstraintType::DifferenceFrom.new 30
  ...
  it "should validate number 60 equal to 60 with error" do
    diffValidator = Referal::ConstraintType::DifferenceFrom.new 60
