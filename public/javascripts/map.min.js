...
MD.date.toCalender = function(ntime,type){
   types = {
       "day": 24*60*60*1000,
   ...
   $("#from").val(MD.date.dateFormat(from,true,true,true));
   $("#to").val(MD.date.dateFormat(to, true, true, true));
   console.log("From: " + MD.date.dateFormat(from,true,true,true));
   console.log("To : " + MD.date.dateFormat(to,true,true,true));
...
MD.visualize.create = function(type){
    type = (typeof type == "undefined")? "day":type;  
    ...
    MD.visualizor = $("#slider").slider({
                                          ...
                                          slide: function(event, ui){
                                            ...
                                            MD.visualize.updateSliderDrag(ntime);
...
MD.visualize.updateSliderDrag = function(ntime){
   ...
   MD.date.toCalender(ntime, MD.visualize.type)
